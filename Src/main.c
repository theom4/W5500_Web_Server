...
uint8_t spi_send(void* spi, uint8_t data)
{
  HAL_SPI_TransmitReceive(&hspi3, &data,&data, 1, 1000);
  return data;
}
...
int main(void)
{
  ...
  struct mg_mgr mgr;
    ...
    {
    		.mac = {0x11, 0x22,0x11,0x22,0x11,0x22},
			.ip = mg_htonl(MG_U32(192,168,137,30)),
			.gw = mg_htonl(MG_U32(192,168,137,1)),
			.mask = mg_htonl(MG_U32(255,255,255,0)),
			.driver_data = &spi_user,
